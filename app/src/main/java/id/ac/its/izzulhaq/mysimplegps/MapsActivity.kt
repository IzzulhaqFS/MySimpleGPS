package id.ac.its.izzulhaq.mysimplegps
...
import id.ac.its.izzulhaq.mysimplegps.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun updateLatLng(newLatLng: LatLng) {
        binding.apply {
            tvLatitude.text = newLatLng.latitude.toString()
            tvLongitude.text = newLatLng.longitude.toString()
        }
    }
